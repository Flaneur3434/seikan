...
is
   ...
   AEAD_Key_Bytes   : constant := 32;  --  chacha20poly1305_KEYBYTES
   AEAD_Nonce_Bytes : constant := 12;  --  chacha20poly1305_ietf_NPUBBYTES
   AEAD_Tag_Bytes   : constant := 16;  --  chacha20poly1305_ABYTES
